...
def main():
    to_group_by_year = ['TA-rent', 'REG-rent', 'HOUSING', 'EMPLOYMENT', 'REAL_TWI', 'MORTGAGE', 'GDP', 'CPI']
    ...
    DF_DICT['VIC-enroll'], DF_DICT['VIC-efts'], DF_DICT['VIC-comp'] = DF_DICT['VIC_SUMM']
